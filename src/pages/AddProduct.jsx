...
const AddProduct = () => {
		...
		const [link, setLink] = useState("https://c0.klipartz.com/pngpicture/621/512/gratis-png-comida-para-perros-cachorro-comida-para-gatos-mascota-comida-para-perros.png");
    ...
    const [discount, setDiscount] = useState(0);
		...
		const clearForm = () => {
			setName("");
			setLink("https://c0.klipartz.com/pngpicture/621/512/gratis-png-comida-para-perros-cachorro-comida-para-gatos-mascota-comida-para-perros.png");
			setPrice(999);
			setCnt(20);
			setWight("0 г");
			setDiscount(0);
